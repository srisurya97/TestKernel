...
#define TI_PREEMPT 40 /* offsetof(struct thread_info, preempt_count) */
...
#define TSK_TI_TTBR0 32 /* offsetof(struct thread_info, ttbr0) */

#define THREAD_CPU_CONTEXT 1424 /* offsetof(struct task_struct, thread.cpu_context) */
